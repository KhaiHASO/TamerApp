...
# Phiên bản model chỉ tương ứng đến lớp thứ hai, thay đổi ở lớp thứ ba cho thấy model tương thích.
# Ví dụ: __version__ = '1.0.*', tương ứng MODEL_VERSION đều là '1.0'
